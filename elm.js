...
Elm.Elmculator = Elm.Elmculator || {};
Elm.Elmculator.Operators = Elm.Elmculator.Operators || {};
Elm.Elmculator.Operators.make = function (_elm) {
   "use strict";
   _elm.Elmculator = _elm.Elmculator || {};
   _elm.Elmculator.Operators = _elm.Elmculator.Operators || {};
   if (_elm.Elmculator.Operators.values)
   return _elm.Elmculator.Operators.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var equals = F2(function (a,b) {    return b;});
   var divide = F2(function (a,b) {    return a / b;});
   var multiply = F2(function (a,b) {    return a * b;});
   var minus = F2(function (a,b) {    return a - b;});
   var plus = F2(function (a,b) {    return a + b;});
   return _elm.Elmculator.Operators.values = {_op: _op
                                             ,plus: plus
                                             ,minus: minus
                                             ,multiply: multiply
                                             ,divide: divide
...
Elm.Elmculator = Elm.Elmculator || {};
Elm.Elmculator.Actions = Elm.Elmculator.Actions || {};
Elm.Elmculator.Actions.make = function (_elm) {
   "use strict";
   _elm.Elmculator = _elm.Elmculator || {};
   _elm.Elmculator.Actions = _elm.Elmculator.Actions || {};
   if (_elm.Elmculator.Actions.values)
   return _elm.Elmculator.Actions.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Elmculator$Operators = Elm.Elmculator.Operators.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   ...
   var SelectOperator = function (a) {
      return {ctor: "SelectOperator",_0: a};
   };
   var TypeNumber = function (a) {
      return {ctor: "TypeNumber",_0: a};
   };
   var Nop = {ctor: "Nop"};
   return _elm.Elmculator.Actions.values = {_op: _op
                                           ,Nop: Nop
...
Elm.Elmculator = Elm.Elmculator || {};
Elm.Elmculator.Keyboard = Elm.Elmculator.Keyboard || {};
Elm.Elmculator.Keyboard.make = function (_elm) {
   "use strict";
   _elm.Elmculator = _elm.Elmculator || {};
   _elm.Elmculator.Keyboard = _elm.Elmculator.Keyboard || {};
   if (_elm.Elmculator.Keyboard.values)
   return _elm.Elmculator.Keyboard.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Char = Elm.Char.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Elmculator$Actions = Elm.Elmculator.Actions.make(_elm),
   $Elmculator$Operators = Elm.Elmculator.Operators.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var keyPressToAction = function (keyCode) {
      var _p0 = $Char.fromCode(keyCode);
      switch (_p0.valueOf())
      {case "1": return $Elmculator$Actions.TypeNumber("1");
         case "2": return $Elmculator$Actions.TypeNumber("2");
         case "3": return $Elmculator$Actions.TypeNumber("3");
         case "4": return $Elmculator$Actions.TypeNumber("4");
         case "5": return $Elmculator$Actions.TypeNumber("5");
         case "6": return $Elmculator$Actions.TypeNumber("6");
         case "7": return $Elmculator$Actions.TypeNumber("7");
         case "8": return $Elmculator$Actions.TypeNumber("8");
         case "9": return $Elmculator$Actions.TypeNumber("9");
         case "0": return $Elmculator$Actions.TypeNumber("0");
         case "+":
         return $Elmculator$Actions.SelectOperator($Elmculator$Operators.plus);
         case "-":
         return $Elmculator$Actions.SelectOperator($Elmculator$Operators.minus);
         case "/":
         return $Elmculator$Actions.SelectOperator($Elmculator$Operators.divide);
         case "*":
         return $Elmculator$Actions.SelectOperator($Elmculator$Operators.multiply);
         case "=":
         return $Elmculator$Actions.SelectOperator($Elmculator$Operators.equals);
         case "C": return $Elmculator$Actions.Clear;
         case "c": return $Elmculator$Actions.Clear;
         default: return $Elmculator$Actions.Nop;}
   };
   var input = A2($Signal.map,keyPressToAction,$Keyboard.presses);
   return _elm.Elmculator.Keyboard.values = {_op: _op
                                            ,input: input};
};
Elm.Elmculator = Elm.Elmculator || {};
Elm.Elmculator.make = function (_elm) {
   "use strict";
   _elm.Elmculator = _elm.Elmculator || {};
   if (_elm.Elmculator.values) return _elm.Elmculator.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Elmculator$Actions = Elm.Elmculator.Actions.make(_elm),
   $Elmculator$Keyboard = Elm.Elmculator.Keyboard.make(_elm),
   $Elmculator$Operators = Elm.Elmculator.Operators.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var applyOperator = F2(function (action,model) {
      var result = $String.toFloat(model.text);
      var a = model.result;
      var _p0 = result;
      if (_p0.ctor === "Ok") {
            return A2(action,a,_p0._0);
         } else {
            return a;
         }
   });
   var numberButton = F2(function (address,number) {
      return A2($Html.button,
      _U.list([$Html$Attributes.$class("calculator__button")
              ,A2($Html$Events.onClick,
              address,
              $Elmculator$Actions.TypeNumber($Basics.toString(number)))]),
      _U.list([$Html.text($Basics.toString(number))]));
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("calculator")]),
      _U.list([A2($Html.h1,
              _U.list([$Html$Attributes.$class("calculator__title")]),
              _U.list([$Html.text("The Elmculator")]))
              ,A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.h2,
                      _U.list([$Html$Attributes.$class("calculator__resultsarea")]),
                      _U.list([$Html.text(model.text)]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2(numberButton,address,1)
                              ,A2(numberButton,address,2)
                              ,A2(numberButton,address,3)
                              ,A2($Html.button,
                              _U.list([$Html$Attributes.$class("calculator__button__operator")
                                      ,A2($Html$Events.onClick,
                                      address,
                                      $Elmculator$Actions.SelectOperator($Elmculator$Operators.plus))]),
                              _U.list([$Html.text("+")]))]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2(numberButton,address,4)
                              ,A2(numberButton,address,5)
                              ,A2(numberButton,address,6)
                              ,A2($Html.button,
                              _U.list([$Html$Attributes.$class("calculator__button__operator")
                                      ,A2($Html$Events.onClick,
                                      address,
                                      $Elmculator$Actions.SelectOperator($Elmculator$Operators.minus))]),
                              _U.list([$Html.text("-")]))]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2(numberButton,address,7)
                              ,A2(numberButton,address,8)
                              ,A2(numberButton,address,9)
                              ,A2($Html.button,
                              _U.list([$Html$Attributes.$class("calculator__button__operator")
                                      ,A2($Html$Events.onClick,
                                      address,
                                      $Elmculator$Actions.SelectOperator($Elmculator$Operators.multiply))]),
                              _U.list([$Html.text("*")]))]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2($Html.button,
                              _U.list([$Html$Attributes.$class("calculator__button__action")
                                      ,A2($Html$Events.onClick,
                                      address,
                                      $Elmculator$Actions.SelectOperator($Elmculator$Operators.equals))]),
                              _U.list([$Html.text("=")]))
                              ,A2(numberButton,address,0)
                              ,A2($Html.button,
                              _U.list([$Html$Attributes.$class("calculator__button__action")
                                      ,A2($Html$Events.onClick,address,$Elmculator$Actions.Clear)]),
                              _U.list([$Html.text("C")]))
                              ,A2($Html.button,
                              _U.list([$Html$Attributes.$class("calculator__button__operator")
                                      ,A2($Html$Events.onClick,
                                      address,
                                      $Elmculator$Actions.SelectOperator($Elmculator$Operators.divide))]),
                              _U.list([$Html.text("/")]))]))]))]));
   });
   var initialModel = {result: 0
                      ,text: ""
                      ,operator: $Elmculator$Operators.plus
                      ,clearBuffer: false};
   var update = F2(function (action,model) {
      var result = function () {
         var _p1 = action;
         switch (_p1.ctor)
         {case "Nop": return model;
            case "TypeNumber": var _p2 = _p1._0;
              return model.clearBuffer ? _U.update(model,
              {text: _p2,clearBuffer: false}) : _U.update(model,
              {text: A2($Basics._op["++"],model.text,_p2)});
            case "SelectOperator": var result = A2(applyOperator,
              model.operator,
              model);
              return _U.update(model,
              {result: result
              ,text: $Basics.toString(result)
              ,clearBuffer: true
              ,operator: _p1._0});
            default: return initialModel;}
      }();
      return {ctor: "_Tuple2",_0: result,_1: $Effects.none};
   });
   var Model = F4(function (a,b,c,d) {
      return {result: a,text: b,operator: c,clearBuffer: d};
   });
   var app = $StartApp.start({init: {ctor: "_Tuple2"
                             ...
                             ,view: view
                             ,update: update
                             ,inputs: _U.list([$Elmculator$Keyboard.input])});
   var main = app.html;
   return _elm.Elmculator.values = {_op: _op
                                   ,app: app
                                   ,main: main
                                   ,Model: Model
